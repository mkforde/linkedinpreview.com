// Verbatim import of https://github.com/blader/humanizer/blob/main/SKILL.md (v2.8.2, MIT).
// Generated from the upstream file. Do not hand-edit; re-import to update.
export const HUMANIZER_SKILL = `# Humanizer: Remove AI Writing Patterns
